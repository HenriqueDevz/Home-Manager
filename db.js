...
async function initDB() {
  ...
  const PRODUTOS = [
    ...
    { name: "FERMENTO",          category: "Básicos" },
    { name: "FUBA",          category: "Básicos" },
    { name: "PÓ ROYAL",          category: "Básicos" },
    ...
    { name: "TEMPEROS",       category: "Básicos" },
    ...
    { name: "PESCADINHA",    category: "Carnes" },
    ...
    { name: "DOCE DE LEITE", category: "Extras" },
